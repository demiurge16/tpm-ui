    ...
    return {
      ...
      withId: (id: string) => {
        return {
          ...
          startReview: (): Observable<TaskNewStatus> => this.patch(`task/${id}/start-review`),
          reject: (): Observable<TaskNewStatus> => this.patch(`task/${id}/reject`),
          approve: (): Observable<TaskNewStatus> => this.patch(`task/${id}/approve`),
          putOnHold: (): Observable<TaskNewStatus> => this.patch(`task/${id}/put-on-hold`),
          resume: (): Observable<TaskNewStatus> => this.patch(`task/${id}/resume`),
